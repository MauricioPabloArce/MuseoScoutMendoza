...
export default async function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      <aside className="w-64 bg-[#1f2937] text-white hidden md:block flex-shrink-0">
        <div className="p-4 border-b border-[#374151] flex flex-col items-center text-center">
